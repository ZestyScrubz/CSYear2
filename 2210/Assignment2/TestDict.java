public class TestDict {
	...
	/*
	 ** Test program for the HashDictionary class.
	...
	public static void main(String[] args) {
		...
		// Test 7: insert 10000 different values into the HashDictionary
		if (test[7])
			try {
				for (i = 0; i < 10000; ++i) {
		...
		// Test 8: check that all inserted values are in the HashDictionary
		boolean pass = true;
		if (test[8]) {
			for (i = 0; i < 10000; ++i) {
				s = (new Integer(i)).toString();
