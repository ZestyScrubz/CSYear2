/**
 * This to due:
 * If the user inputs more than 99 character for restaurant name and dish name, take only the first 99 character
 * 
*/
...
int main(void) {
    ...
    while (operationCode != 'q') {
        ...
        // get the operation code and run the corresponding method
        if (operationCode == 'i') {
            newDish();
...
int newDish(void) {
    ...
    if (dishCount >= MAX_DISH_CODE) {
        printf("Data base if full.\n");
        return 1;
    }
